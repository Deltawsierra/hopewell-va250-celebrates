    ...
    >
      ...
      >
        ...
        <g filter="url(#wave)">
          ...
          {/* Stars in proper US flag pattern */}
          <g>
            {[
              [0, 6, 14, 16],   // Row 1: 6 stars
              [1, 5, 36, 28],   // Row 2: 5 stars (offset)
              [2, 6, 58, 16],   // Row 3: 6 stars
              [3, 5, 80, 28],   // Row 4: 5 stars (offset)
              [4, 6, 102, 16],  // Row 5: 6 stars
              [5, 5, 124, 28],  // Row 6: 5 stars (offset)
              [6, 6, 146, 16],  // Row 7: 6 stars
              [7, 5, 168, 28],  // Row 8: 5 stars (offset)
